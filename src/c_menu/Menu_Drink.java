...
public class Menu_Drink extends JPanel {
	Menu_Main main;
	final String IMG_PATH = "src/images/";
	List<MenuVO> list;
	int menuCnt;

	JButton drink_btn1, drink_btn2, drink_btn3, drink_btn4;
	JButton drink_btn5, drink_btn6, drink_btn7, drink_btn8;
	...
	// ImageIcon bg1 = new ImageIcon("src/picture/bg5.png");
	public Menu_Drink(Menu_Main main, CategoryVO cvo) {
		...
		// drink menu1
		if (menuCnt >= 1) {
			drink_btn1 = new JButton("콜라");
			drink_btn1.setBackground(Color.DARK_GRAY);
			ImageIcon img1 = new ImageIcon(IMG_PATH + list.get(0).getImage());

			drink_btn1.setIcon(img1);
			drink_btn1.setBounds(30, 35, 200, 200);
			add(drink_btn1);
			...
			drink_btn1.addActionListener(new ActionListener() {
				@Override
				public void actionPerformed(ActionEvent e) {
					...
					if (selectedMenu == null) { // 최초 선택한 경우
						drink_btn1.setBorder(new LineBorder(Color.RED, 7));
						...
						drink_btn1.setBorder(new LineBorder(Color.BLACK, 1));
						spinner1.setValue(0);
						spinner1.setEnabled(false);
		...
		// drink menu2
		if (menuCnt >= 2) {
			drink_btn2 = new JButton("사이다");
			drink_btn2.setBackground(Color.DARK_GRAY);
			ImageIcon img2 = new ImageIcon(IMG_PATH + list.get(1).getImage());
			drink_btn2.setIcon(img2);
			drink_btn2.setBounds(270, 35, 200, 200);
			add(drink_btn2);
			...
			// 메뉴 사진을 누르면 해당 메뉴가 선택된다.
			drink_btn2.addActionListener(new ActionListener() {
				@Override
				public void actionPerformed(ActionEvent e) {
					// 고객이 선택한 메뉴리스트에 존재하는지 여부를 확인한다.
					SelectedMenu selectedMenu = main.getSelectedMenu(list.get(1).getM_id());
					if (selectedMenu == null) { // 최초 선택한 경우
						drink_btn2.setBorder(new LineBorder(Color.RED, 7));
						...
						drink_btn2.setBorder(new LineBorder(Color.BLACK, 1));
						spinner2.setValue(0);
						spinner2.setEnabled(false);
		...
		// drink menu3
		if (menuCnt >= 3) {
			drink_btn3 = new JButton("라무네");
			drink_btn3.setBackground(Color.DARK_GRAY);
			ImageIcon img3 = new ImageIcon(IMG_PATH + list.get(2).getImage());
			drink_btn3.setIcon(img3);
			drink_btn3.setBounds(510, 35, 200, 200);
			add(drink_btn3);
			...
			JButton c_btn3 = new JButton("장바구니");
			...
			// 메뉴 사진을 누르면 해당 메뉴가 선택된다.
			drink_btn3.addActionListener(new ActionListener() {
				@Override
				public void actionPerformed(ActionEvent e) {
					// 고객이 선택한 메뉴리스트에 존재하는지 여부를 확인한다.
					SelectedMenu selectedMenu = main.getSelectedMenu(list.get(2).getM_id());
					if (selectedMenu == null) { // 최초 선택한 경우
						drink_btn3.setBorder(new LineBorder(Color.RED, 7));
						...
						drink_btn3.setBorder(new LineBorder(Color.BLACK, 1));
						spinner3.setValue(0);
						spinner3.setEnabled(false);
		...
		// drink menu4
		if (menuCnt >= 4) {
			drink_btn4 = new JButton("아사히");
			drink_btn4.setBackground(Color.DARK_GRAY);
			ImageIcon img4 = new ImageIcon(IMG_PATH + list.get(3).getImage());
			drink_btn4.setIcon(img4);
			drink_btn4.setBounds(750, 35, 200, 200);
			add(drink_btn4);
			...
			JButton c_btn4 = new JButton("장바구니");
			...
			// 메뉴 사진을 누르면 해당 메뉴가 선택된다.
			drink_btn4.addActionListener(new ActionListener() {
				@Override
				public void actionPerformed(ActionEvent e) {
					// 고객이 선택한 메뉴리스트에 존재하는지 여부를 확인한다.
					SelectedMenu selectedMenu = main.getSelectedMenu(list.get(3).getM_id());
					if (selectedMenu == null) { // 최초 선택한 경우
						drink_btn4.setBorder(new LineBorder(Color.RED, 7));
						...
						drink_btn4.setBorder(new LineBorder(Color.BLACK, 1));
						spinner4.setValue(0);
						spinner4.setEnabled(false);
		...
		// drink menu5
		if (menuCnt >= 5) {
			drink_btn5 = new JButton("기린");
			drink_btn5.setBackground(Color.DARK_GRAY);
			ImageIcon img5 = new ImageIcon(IMG_PATH + list.get(4).getImage());
			drink_btn5.setIcon(img5);
			drink_btn5.setBounds(30, 365, 200, 200);
			add(drink_btn5);
			...
			price5.setFont(new Font("EF_다이어리", Font.BOLD, 17));
			...
			JButton c_btn5 = new JButton("장바구니");
			...
			// 메뉴 사진을 누르면 해당 메뉴가 선택된다.
			drink_btn5.addActionListener(new ActionListener() {
				@Override
				public void actionPerformed(ActionEvent e) {
					// 고객이 선택한 메뉴리스트에 존재하는지 여부를 확인한다.
					SelectedMenu selectedMenu = main.getSelectedMenu(list.get(4).getM_id());
					if (selectedMenu == null) { // 최초 선택한 경우
						drink_btn5.setBorder(new LineBorder(Color.RED, 7));
						...
						drink_btn5.setBorder(new LineBorder(Color.BLACK, 1));
						spinner5.setValue(0);
						spinner5.setEnabled(false);
		...
		// drink menu6
		if (menuCnt >= 6) {
			drink_btn6 = new JButton("하이볼");
			drink_btn6.setBackground(Color.DARK_GRAY);
			ImageIcon img6 = new ImageIcon(IMG_PATH + list.get(5).getImage());
			drink_btn6.setIcon(img6);
			drink_btn6.setBounds(270, 365, 200, 200);
			add(drink_btn6);
			...
			JButton c_btn6 = new JButton("장바구니");
			...
			add(c_btn6);
			// 메뉴 사진을 누르면 해당 메뉴가 선택된다.
			drink_btn6.addActionListener(new ActionListener() {
				@Override
				public void actionPerformed(ActionEvent e) {
					// 고객이 선택한 메뉴리스트에 존재하는지 여부를 확인한다.
					SelectedMenu selectedMenu = main.getSelectedMenu(list.get(5).getM_id());
					if (selectedMenu == null) { // 최초 선택한 경우
						drink_btn6.setBorder(new LineBorder(Color.RED, 7));
						...
						drink_btn6.setBorder(new LineBorder(Color.BLACK, 1));
						spinner6.setValue(0);
						spinner6.setEnabled(false);
		...
		// drink menu7
		if (menuCnt >= 7) {
			drink_btn7 = new JButton("자몽에이드");
			drink_btn7.setBackground(Color.DARK_GRAY);
			ImageIcon img7 = new ImageIcon(IMG_PATH + list.get(6).getImage());
			drink_btn7.setIcon(img7);
			drink_btn7.setBounds(510, 365, 200, 200);
			add(drink_btn7);

			JLabel menu7 = new JLabel(list.get(6).getM_name());
			menu7.setForeground(Color.WHITE);
			menu7.setFont(new Font("안성탕면체 Bold", Font.BOLD, 17));
			...
			JButton c_btn7 = new JButton("장바구니");
			...
			add(c_btn7);
			// 메뉴 사진을 누르면 해당 메뉴가 선택된다.
			drink_btn7.addActionListener(new ActionListener() {
				@Override
				public void actionPerformed(ActionEvent e) {
					// 고객이 선택한 메뉴리스트에 존재하는지 여부를 확인한다.
					SelectedMenu selectedMenu = main.getSelectedMenu(list.get(6).getM_id());
					if (selectedMenu == null) { // 최초 선택한 경우
						drink_btn7.setBorder(new LineBorder(Color.RED, 7));
						...
						drink_btn7.setBorder(new LineBorder(Color.BLACK, 1));
						spinner7.setValue(0);
						spinner7.setEnabled(false);
		...
		// drink menu8
		if (menuCnt>=8) {
			drink_btn8 = new JButton("레몬에이드");
			drink_btn8.setBackground(Color.DARK_GRAY);
			ImageIcon img8 = new ImageIcon(IMG_PATH + list.get(7).getImage());
			drink_btn8.setIcon(img8);
			drink_btn8.setBounds(750, 365, 200, 200);
			add(drink_btn8);

			JLabel menu8 = new JLabel(list.get(7).getM_name());
			menu8.setForeground(Color.WHITE);
			menu8.setFont(new Font("안성탕면체 Bold", Font.BOLD, 17));
			...
			JButton c_btn8 = new JButton("장바구니");
			...
			add(c_btn8);
			// 메뉴 사진을 누르면 해당 메뉴가 선택된다.
			drink_btn8.addActionListener(new ActionListener() {
				@Override
				public void actionPerformed(ActionEvent e) {
					// 고객이 선택한 메뉴리스트에 존재하는지 여부를 확인한다.
					SelectedMenu selectedMenu = main.getSelectedMenu(list.get(7).getM_id());
					if (selectedMenu == null) { // 최초 선택한 경우
						drink_btn8.setBorder(new LineBorder(Color.RED, 7));
						...
						drink_btn8.setBorder(new LineBorder(Color.BLACK, 1));
						spinner8.setValue(0);
						spinner8.setEnabled(false);
